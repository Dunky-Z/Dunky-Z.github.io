...
![](https://gitee.com/dominic_z/markdown_picbed/raw/master/img/20210826183622.png)
...
### 任务ID
    ...
    ```
    为何要有这么多ID，一个不够吗？
    一、可以方便任务展示，比如在命令行中ps显示所有进程，只显示`pid_t pid`，而不会把所有内部线程摊开展示，这样太碍眼。二、方便下达命令，当我kill一个进程时，我们是对整个进程发送信号，但是有时候一些命令只需要对某个线程发送信号。三、
...
![](https://gitee.com/dominic_z/markdown_picbed/raw/master/img/20210826190834.png)
